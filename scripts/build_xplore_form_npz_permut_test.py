...
step=0.5
ori_size=np.array([int(np.floor(int(i)/step)) for i in sys.argv[2].split(',') ])
path="/home/marciniega/Things_ulises"
ori_grid=read_npz_file("npzs/%s.npz"%filetarget)       
#dic_pert = {"px1":[1,ori_size[0],ori_size[1],ori_size[2]],
#            "px2":[1,ori_size[0],ori_size[2],ori_size[1]],
#            "py1":[1,ori_size[2],ori_size[1],ori_size[0]],
#            "py2":[1,ori_size[2],ori_size[0],ori_size[1]],
#            "pz1":[1,ori_size[1],ori_size[0],ori_size[2]],
#            "pz2":[1,ori_size[1],ori_size[2],ori_size[0]]}

dic_pert = {"px1":[0,1,2,3],
            "px2":[0,1,3,2],
            "py1":[0,3,2,1],
            "py2":[0,3,1,2],
            "pz1":[0,2,1,3],
...
for nm,pert_lgth in dic_pert.items():
    dens_grid = np.transpose(ori_grid,pert_lgth)
    outname=nm
